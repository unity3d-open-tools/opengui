...
"agal_vs
[bc]
adaaaaaaahaaapaeacaaaaoeaaaaaaaaafaaaaoeabaaaaaa mul v7, a2, c5
...
// FLOW 1 static, 0 dynamic
"vs_4_0_level_9_1
eefiecedmejfagibabkdddlangafmlbmgaphdcejabaaaaaaieadaaaaaeaaaaaa
...
lowp vec4 frag( in v2f i ) {
    #line 342
    lowp vec4 col = i.color;
    col.w *= texture( _MainTex, i.texcoord).w;
    return col;
}
...
// FLOW 1 static, 0 dynamic
"ps_4_0
eefiecedfbcgfcdgadggennmgadlbohgbajggpmmabaaaaaaieabaaaaadaaaaaa
...
// FLOW 1 static, 0 dynamic
"ps_4_0_level_9_1
eefiecedhakaglplkkhiknmmodigokhhmkeipkcnabaaaaaabmacaaaaaeaaaaaa
